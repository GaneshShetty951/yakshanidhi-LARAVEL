            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><img src="/mela_images/{{ $mela->mela_pic }}" style="width: 200px;height=200px;"></a>
                    <!-- <ul class="nav child_menu">
                      <li><a href="{{url('/prasangha_add')}}">Add</a></li>
                      <li><a href="{{url('/prasangha_update')}}">Modify</a></li>
                      <li><a href="{{url('/prasangha_list')}}">List</a></li>
                    </ul> -->
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Show <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/man_show_add')}}">Add</a></li>
                      <li><a href="{{url('/man_show_update')}}">Modify</a></li>
                      <li><a href="{{url('/man_show_list')}}">List</a></li>
                    </ul>
                  </li>
                  <!-- <li><a><i class="fa fa-user"></i>Artists <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/artist_add')}}">Add</a></li>
                      <li><a href="{{url('/artist_update')}}">Modify</a></li>
                      <li><a href="{{url('/artist_list')}}">List</a></li>
                    </ul>
                  </li> -->
