              ...
              <div id="step-1">
                ...
                <form class="form-horizontal form-label-left"  method="post" enctype="multipart/form-data" action="{{ url('/role_update') }}" >
                  ...
                  <div class="form-group" >
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="mela_name" name="mela_name" list="melas" required="required" disabled class="form-control col-md-7 col-xs-12"  value="{{App\Mela::where('manager_id','=',$value->id)->select('mela_name')->get()[0]->mela_name }}">
                      <datalist id="melas">
                      @if($melas)
                         @foreach($melas as $value1)
                          <option value="{{ App\Mela::where('manager_id','=',$value->id)->pluck('mela_name') }}"></option>
                        @endforeach
                      @endif
                      </datalist>
                    </div>
